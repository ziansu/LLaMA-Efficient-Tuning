...
class Template:
    ...
    def __post_init__(self):
        ...
        elif self.name == "dcrn-instruct":
            r"""
            TODO: Support the instruction tuning paradigm of decomplied code renaming
            """
            raise NotImplementedError(
                "dcrn-instruct need to support a more complex prompt of inputting both decompiled code and the specific name to rename"
            )
